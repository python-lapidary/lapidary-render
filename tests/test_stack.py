...
from lapidary.render.model.python import AnnotatedType, GenericType


def test_resolve_type_hint():
    expected = AnnotatedType(GenericType(python.NameRef('pkg.paths.u_lpathu_l.get.parameters.u_m', 'schema')))
