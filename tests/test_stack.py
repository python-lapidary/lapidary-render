from lapidary_render.model import python, schemamodel, stack
...
def test_resolve_type_hint():
    ...
    type_hint = schemamodel.resolve_type_name('pkg', stack.Stack.from_str('#/paths/~1path~1/get/parameters/0/schema'))
