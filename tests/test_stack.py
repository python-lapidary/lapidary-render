from lapidary_render.model import conv_schemamodel, python, stack
...
def test_resolve_type_hint():
    ...
    type_hint = conv_schemamodel.resolve_type_name(
        'pkg', stack.Stack.from_str('#/paths/~1path~1/get/parameters/0/schema')
    )
